...
export default function EventoDetalhes() {
  ...
  return (
    <div className="min-h-screen pb-20">
      {/* Hero Section */}
      <div className="relative h-[360px] sm:h-[400px] md:h-[500px] overflow-hidden">
        <img 
          src={event.image} 
          alt={event.title} 
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 md:p-12">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-wrap gap-2 sm:gap-3 mb-4 sm:mb-6">
              <span className="px-3 sm:px-4 py-1.5 bg-primary text-white text-[9px] sm:text-[10px] font-black uppercase tracking-widest rounded-full shadow-lg shadow-red-500/40">
                {event.tag}
              </span>
              <span className="px-3 sm:px-4 py-1.5 bg-emerald-500 text-white text-[9px] sm:text-[10px] font-black uppercase tracking-widest rounded-full shadow-lg shadow-emerald-500/40">
                Inscrições Abertas
              </span>
            </div>
            <h1 className="text-[30px] sm:text-4xl md:text-6xl font-black text-white mb-4 sm:mb-6 tracking-tight leading-tight max-w-4xl">
              {event.title}
            </h1>
            <div className="flex flex-col sm:flex-row sm:flex-wrap gap-3 sm:gap-6 text-white/80 font-bold text-xs sm:text-sm">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 mt-8 sm:mt-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 sm:gap-12">
          ...
          <div className="lg:col-span-2 space-y-8 sm:space-y-12">
            ...
            <div className="flex gap-2 overflow-x-auto pb-4 border-b border-slate-200">
              {tabs.map((tab) => (
                <button
                  ...
                  className={`flex items-center gap-2 px-4 sm:px-6 py-3 rounded-2xl text-xs sm:text-sm font-black uppercase tracking-widest transition-all whitespace-nowrap ${
                    activeTab === tab.id 
            ...
            {/* Tab Content */}
            <div className="bg-white/40 backdrop-blur-md rounded-[28px] sm:rounded-[40px] border border-white/20 p-5 sm:p-8 md:p-12 shadow-sm">
              {activeTab === 'info' && (
                <div className="prose prose-slate max-w-none">
                  <h2 className="text-xl sm:text-2xl font-black text-slate-900 mb-5 sm:mb-6">Sobre o Evento</h2>
                  ...
                  <h3 className="text-lg sm:text-xl font-black text-slate-900 mb-4">O que está incluso:</h3>
                  <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                    {[
                      ...
                      <li key={i} className="flex items-center gap-3 text-slate-600 font-bold text-sm leading-relaxed">
                        <CheckCircle2 className="w-5 h-5 text-emerald-500" />
                        {item}
                      </li>
                    ))}
                  </ul>
                  <h3 className="text-lg sm:text-xl font-black text-slate-900 mb-4">Programação:</h3>
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={i} className="flex items-center gap-4 sm:gap-6 p-4 bg-white/50 rounded-2xl border border-white/20">
                        <span className="text-primary font-black text-base sm:text-lg">{item.time}</span>
              ...
              {activeTab === 'categories' && (
                <div className="space-y-6">
                  <h2 className="text-xl sm:text-2xl font-black text-slate-900 mb-6">Categorias Disponíveis</h2>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {[
                      ...
                      <div key={i} className="relative p-5 sm:p-8 bg-white/50 rounded-[24px] sm:rounded-[32px] border border-white/20 hover:border-primary hover:shadow-2xl transition-all group cursor-pointer overflow-hidden">
                        <div className="absolute top-0 right-0 w-32 h-32 bg-primary/5 rounded-full -mr-16 -mt-16 group-hover:bg-primary/10 transition-colors"></div>
                        
                        <div className="relative z-10">
                          <div className="flex justify-between items-start mb-4">
                            <h4 className="text-base sm:text-lg font-black text-slate-900 group-hover:text-primary transition-colors">{cat.name}</h4>
                          ...
                          <div className="flex flex-wrap items-center gap-3 sm:gap-4 mb-6 text-[10px] text-slate-500 font-black uppercase tracking-widest">
                          ...
                          <div className="flex items-baseline gap-2">
                            <span className="text-xl sm:text-2xl font-black text-slate-900 group-hover:scale-110 origin-left transition-transform duration-300">{cat.price}</span>
              ...
              {activeTab === 'rules' && (
                <div className="space-y-6">
                  <h2 className="text-xl sm:text-2xl font-black text-slate-900 mb-6">Regulamento</h2>
                  <div className="p-5 sm:p-8 bg-slate-900/5 rounded-[24px] sm:rounded-3xl border border-slate-900/10">
                    ...
                    <button className="w-full sm:w-auto flex items-center justify-center gap-3 px-6 sm:px-8 py-4 bg-slate-900 text-white rounded-2xl font-black uppercase tracking-widest text-xs sm:text-sm hover:bg-slate-800 transition-all">
              ...
              {activeTab === 'organizer' && (
                <div className="text-center py-4 sm:py-8">
                  <div className="w-20 h-20 sm:w-24 sm:h-24 bg-white rounded-full flex items-center justify-center mx-auto mb-5 sm:mb-6 overflow-hidden border-4 border-white shadow-xl">
                    <img src="/logo-v.png" alt="Z5 Sports Management" className="w-full h-full object-contain p-2" />
                  </div>
                  <h3 className="text-xl sm:text-2xl font-black text-slate-900 mb-2">Z5 Sports Management</h3>
                  <p className="text-sm sm:text-base text-slate-500 font-medium mb-6 sm:mb-8 max-w-md mx-auto">
          ...
          <div className="space-y-6">
            <div className="sticky top-24 space-y-5 sm:space-y-6">
              <div className="bg-white/60 backdrop-blur-xl rounded-[28px] sm:rounded-[40px] border border-white/30 p-5 sm:p-8 shadow-2xl shadow-slate-900/5">
                <div className="mb-6 sm:mb-8">
                  <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-2">Inscrições a partir de</p>
                  <div className="flex items-baseline gap-2">
                    <span className="text-3xl sm:text-4xl font-black text-slate-900 tracking-tighter">{event.price}</span>
                    <span className="text-slate-500 font-bold text-xs sm:text-sm">/ atleta</span>
                  </div>
                </div>
                ...
                <button 
                  ...
                  className="w-full bg-primary text-white py-4 sm:py-5 rounded-[20px] sm:rounded-[24px] font-black uppercase tracking-widest text-xs sm:text-sm hover:bg-red-700 transition-all shadow-xl shadow-red-500/30 active:scale-95 mb-4"
                >
                  Inscrever-se Agora
                </button>
                ...
                <div className="flex gap-2">
                  ...
                  <button className="p-3.5 sm:p-4 bg-white border border-slate-200 rounded-2xl text-slate-400 hover:text-primary hover:border-primary transition-all">
              ...
              {/* Location Card */}
              <div className="bg-white/40 backdrop-blur-md rounded-[28px] sm:rounded-[40px] border border-white/20 p-5 sm:p-8 shadow-sm">
                <h4 className="font-black text-slate-900 mb-4 uppercase tracking-widest text-xs">Localização</h4>
                <div className="aspect-video bg-slate-200 rounded-[24px] sm:rounded-3xl mb-4 overflow-hidden relative">
                  <img 
